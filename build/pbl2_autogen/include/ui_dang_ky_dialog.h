...
public:
    ...
    void setupUi(QMainWindow *dang_ky_dialog)
    {
        ...
        mat_khau_sai_label = new QLabel(centralwidget);
        mat_khau_sai_label->setObjectName("mat_khau_sai_label");
        mat_khau_sai_label->setGeometry(QRect(750, 410, 291, 20));
    ...
    void retranslateUi(QMainWindow *dang_ky_dialog)
    {
        ...
        mat_khau_sai_label->setText(QString());
    } // retranslateUi
